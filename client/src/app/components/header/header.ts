  ...
  template: `
    <header class="sticky top-0 z-50 backdrop-blur-xl bg-bg-primary/85 border-b border-border-glass">
      <div class="max-w-2xl mx-auto px-4 h-14 flex items-center gap-2.5">
        ...
        <div>
          <h1 class="neon-text text-base font-bold tracking-[0.015em] uppercase leading-none text-text-primary">
            Voto Subito
          </h1>
          <p class="text-[10px] tracking-[0.015em] uppercase text-text-muted leading-none mt-1">
