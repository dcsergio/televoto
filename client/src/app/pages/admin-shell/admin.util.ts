...
export type AdminSection = 'events' | 'candidates' | 'voting-codes' | 'voting-backstage';

const ADMIN_SECTIONS: AdminSection[] = ['events', 'candidates', 'voting-codes', 'voting-backstage'];
